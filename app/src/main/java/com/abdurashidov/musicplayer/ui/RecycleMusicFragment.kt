...
import com.abdurashidov.musicplayer.adapters.MyRvAdapter
import com.abdurashidov.musicplayer.databinding.FragmentRecycleMusicBinding
import com.abdurashidov.musicplayer.models.Music
import com.abdurashidov.musicplayer.models.MyData
import kotlin.time.Duration.Companion.milliseconds

@Suppress("DEPRECATION")
class RecycleMusicFragment : Fragment(), MyRvAdapter.RvClick {


    private lateinit var binding: FragmentRecycleMusicBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRecycleMusicBinding.inflate(layoutInflater)
        list = ArrayList()
